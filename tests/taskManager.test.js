...
export function runTaskManagerTests(assert) {
  ...
  // Helper pure TaskManager logic for isolated unit testing
  ...
  // Test 7: Real-Time Statistics Calculation
  tests.push({
